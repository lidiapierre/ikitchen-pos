...
function BarChart({ data }: BarChartProps): JSX.Element {
  if (data.length === 0) {
    return <div className="text-brand-grey text-sm py-4">No data for this period</div>
  }
...
function CompDetailTable({ items }: CompDetailTableProps): JSX.Element {
  if (items.length === 0) {
    return <p className="text-brand-grey text-sm">No comped items for this period</p>
  }
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-sm">
        <thead>
          <tr className="text-left text-brand-navy/60 border-b border-brand-grey">
        ...
        <tbody>
          {items.map((item, idx) => (
            <tr key={idx} className="border-b border-brand-grey/50">
              ...
              <td className="py-2 pr-3 text-brand-navy/60 max-w-[160px] truncate">
                {item.reason ?? <span className="italic text-zinc-600">—</span>}
              </td>
              <td className="py-2 pr-3 text-brand-navy/60">
      ...
      {items.map(item => {
        ...
        return (
          <div key={item.item_name}>
            ...
            <div className="h-2 bg-brand-offwhite rounded-full overflow-hidden">
              <div
          ...
          {rows.map((row, idx) => {
            ...
            return (
              <tr key={row.server_id} className="border-b border-brand-grey/50">
                ...
                <td className="py-2 pr-3 text-brand-navy/80 text-right">{row.total_orders}</td>
...
export default function ReportsDashboard(): JSX.Element {
  ...
  return (
    <div className="space-y-6">
            ...
            <button
              ...
              className={[
                ...
                period === value
                  ...
                  : 'bg-white text-brand-navy/80 hover:bg-brand-offwhite border border-brand-grey',
              ].join(' ')}
            >
              {label}
            </button>
      ...
      {period === 'custom' && (
        <div className="bg-white border border-brand-grey rounded-2xl p-4 flex flex-wrap items-end gap-3">
          <div className="flex flex-col gap-1">
            <label className="text-xs text-brand-navy/60 font-medium">From</label>
            <input
              type="date"
              value={customFrom}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs text-brand-navy/60 font-medium">To</label>
            <input
              type="date"
              value={customTo}
      ...
      {/* Loading */}
      {loading && (
        <div className="text-brand-navy/60 text-sm py-4 text-center animate-pulse">Loading reports…</div>
      )}
        ...
        <>
          ...
          <div className="bg-white border border-brand-grey rounded-2xl p-6">
            <div className="flex items-center justify-between gap-3 mb-4">
              <h2 className="text-base font-semibold text-brand-navy">Revenue by Day</h2>
              <ExportButton
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white border border-brand-grey rounded-2xl p-6">
              <div className="flex items-center justify-between gap-3 mb-4">
                <h2 className="text-base font-semibold text-brand-navy">Top Items</h2>
                <ExportButton
              ...
              {data.top_items.length === 0 ? (
                <p className="text-brand-grey text-sm">No item data for this period</p>
              ) : (
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-left text-brand-navy/60 border-b border-brand-grey">
            ...
            <div className="bg-white border border-brand-grey rounded-2xl p-6">
              <div className="flex items-center justify-between gap-3 mb-4">
                <h2 className="text-base font-semibold text-brand-navy">Payment Methods</h2>
                <ExportButton
              ...
              {data.payment_breakdown.length === 0 ? (
                <p className="text-brand-grey text-sm">No payment data for this period</p>
              ) : (
                <div className="space-y-3">
          ...
          {data.comp_detail && (
            <div className="bg-white border border-brand-grey rounded-2xl p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                <h2 className="text-base font-semibold text-brand-navy">Comp Item Detail</h2>
          ...
          <div className="bg-white border border-brand-grey rounded-2xl p-6">
            <div className="flex items-center justify-between gap-3 mb-4">
              <div>
                <h2 className="text-base font-semibold text-brand-navy">Staff Performance</h2>
                <p className="text-sm text-brand-navy/60 mt-0.5">Orders and revenue per server — sorted by revenue</p>
              </div>
            </div>
          ...
          <div className="bg-white border border-brand-grey rounded-2xl p-6">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              <div>
                <h2 className="text-base font-semibold text-brand-navy">Accounting Export</h2>
          ...
          <div className="bg-white border border-brand-grey rounded-2xl p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>
                <h2 className="text-base font-semibold text-brand-navy">Full Order List</h2>
                <p className="text-sm text-brand-navy/60 mt-0.5">
      ...
      {/* Empty state */}
      {!loading && !data && !error && (
        <div className="text-brand-grey text-sm text-center py-12">
